...
import com.clovrlabs.wallet.job.JobManager;
...
public class ClovrFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Logger log = ClovrLogger.getLogger(getApplicationContext(), TAG);
        log.info("FCM notification received! isBackground=" + ClovrApplication.isBackground + " isRunning=" + ClovrApplication.isRunning);
        ...
        if (ClovrApplication.isBackground || !ClovrApplication.isRunning) {
