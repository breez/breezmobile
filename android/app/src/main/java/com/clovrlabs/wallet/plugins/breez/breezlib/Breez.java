...
import static com.clovrlabs.wallet.plugins.breez.breezlib.ChainSync.UNIQUE_WORK_NAME;
        ...
        public void run() {
            ...
            try {
                ...
                if (method.getParameterTypes().length > 1) {
                    Breez.this.fail(m_result, "NotSupported", "ClovrWallet supports only methods with none or one arguments", "ResultError");
                    return;
                }
