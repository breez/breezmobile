...
const SpontaneousPaymentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'routeHints', '3': 8, '4': 3, '5': 11, '6': '.data.RouteHint', '10': 'routeHints'},
  ],
...
const HopHint$json = const {
  ...
  '2': const [
    ...
    const {'1': 'chan_id', '3': 2, '4': 1, '5': 4, '10': 'chanId'},
...
const RouteHint$json = const {
  '1': 'RouteHint',
  '2': const [
    const {'1': 'hop_hints', '3': 1, '4': 3, '5': 11, '6': '.data.HopHint', '10': 'hopHints'},
  ],
};

const RoutingHints$json = const {
  '1': 'RoutingHints',
  '2': const [
    const {'1': 'hints', '3': 1, '4': 3, '5': 11, '6': '.data.RouteHint', '10': 'hints'},
  ],
};
