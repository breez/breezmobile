...
@$pb.GrpcServiceName('data.BreezAPI')
class BreezAPIClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.ConnectLSPReply> connectToLSP($0.ConnectLSPRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.FundStatusReply> getFundStatus($0.FundStatusRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getFundStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.AddInvoiceReply> addInvoice($0.AddInvoiceRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addInvoice, request, options: options);
  }

  $grpc.ResponseFuture<$0.PaymentResponse> payInvoice($0.PayInvoiceRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$payInvoice, request, options: options);
  }

  $grpc.ResponseFuture<$0.RestartDaemonReply> restartDaemon($0.RestartDaemonRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$restartDaemon, request, options: options);
  }

  $grpc.ResponseFuture<$0.PaymentsList> listPayments($0.ListPaymentsRequest request, {$grpc.CallOptions? options}) {
...
abstract class BreezAPIServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.LSPList> getLSPList_Pre($grpc.ServiceCall call, $async.Future<$0.LSPListRequest> request) async {
    return getLSPList(call, await request);
  }

  $async.Future<$0.ConnectLSPReply> connectToLSP_Pre($grpc.ServiceCall call, $async.Future<$0.ConnectLSPRequest> request) async {
  ...
  $async.Future<$0.FundStatusReply> getFundStatus_Pre($grpc.ServiceCall call, $async.Future<$0.FundStatusRequest> request) async {
    return getFundStatus(call, await request);
  }

  $async.Future<$0.AddInvoiceReply> addInvoice_Pre($grpc.ServiceCall call, $async.Future<$0.AddInvoiceRequest> request) async {
    return addInvoice(call, await request);
  }

  $async.Future<$0.PaymentResponse> payInvoice_Pre($grpc.ServiceCall call, $async.Future<$0.PayInvoiceRequest> request) async {
    return payInvoice(call, await request);
  }

  $async.Future<$0.RestartDaemonReply> restartDaemon_Pre($grpc.ServiceCall call, $async.Future<$0.RestartDaemonRequest> request) async {
    return restartDaemon(call, await request);
  }

  $async.Future<$0.PaymentsList> listPayments_Pre($grpc.ServiceCall call, $async.Future<$0.ListPaymentsRequest> request) async {
