...
@$pb.GrpcServiceName('breez.Invoicer')
class InvoicerClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.RegisterReply> registerDevice($0.RegisterRequest request, {$grpc.CallOptions? options}) {
...
abstract class InvoicerServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.RegisterReply> registerDevice_Pre($grpc.ServiceCall call, $async.Future<$0.RegisterRequest> request) async {
    return registerDevice(call, await request);
  }

  $async.Future<$0.InvoiceReply> sendInvoice_Pre($grpc.ServiceCall call, $async.Future<$0.PaymentRequest> request) async {
...
@$pb.GrpcServiceName('breez.CardOrderer')
...
abstract class CardOrdererServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.OrderReply> order_Pre($grpc.ServiceCall call, $async.Future<$0.OrderRequest> request) async {
    return order(call, await request);
  }

  $async.Future<$0.OrderReply> order($grpc.ServiceCall call, $0.OrderRequest request);
}
@$pb.GrpcServiceName('breez.Pos')
class PosClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.UploadFileReply> uploadLogo($0.UploadFileRequest request, {$grpc.CallOptions? options}) {
...
abstract class PosServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.UploadFileReply> uploadLogo_Pre($grpc.ServiceCall call, $async.Future<$0.UploadFileRequest> request) async {
...
@$pb.GrpcServiceName('breez.Information')
class InformationClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.BreezAppVersionsReply> breezAppVersions($0.BreezAppVersionsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$breezAppVersions, request, options: options);
  }

  $grpc.ResponseFuture<$0.ReceiverInfoReply> receiverInfo($0.ReceiverInfoRequest request, {$grpc.CallOptions? options}) {
...
abstract class InformationServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.RatesReply> rates_Pre($grpc.ServiceCall call, $async.Future<$0.RatesRequest> request) async {
    return rates(call, await request);
  }

  $async.Future<$0.BreezAppVersionsReply> breezAppVersions_Pre($grpc.ServiceCall call, $async.Future<$0.BreezAppVersionsRequest> request) async {
    return breezAppVersions(call, await request);
  }

  $async.Future<$0.ReceiverInfoReply> receiverInfo_Pre($grpc.ServiceCall call, $async.Future<$0.ReceiverInfoRequest> request) async {
  ...
  $async.Future<$0.BreezAppVersionsReply> breezAppVersions($grpc.ServiceCall call, $0.BreezAppVersionsRequest request);
  $async.Future<$0.ReceiverInfoReply> receiverInfo($grpc.ServiceCall call, $0.ReceiverInfoRequest request);
}
@$pb.GrpcServiceName('breez.ChannelOpener')
class ChannelOpenerClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.RegisterPaymentReply> registerPayment($0.RegisterPaymentRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerPayment, request, options: options);
  }

  $grpc.ResponseFuture<$0.CheckChannelsReply> checkChannels($0.CheckChannelsRequest request, {$grpc.CallOptions? options}) {
...
abstract class ChannelOpenerServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.LSPListReply> lSPList_Pre($grpc.ServiceCall call, $async.Future<$0.LSPListRequest> request) async {
    return lSPList(call, await request);
  }

  $async.Future<$0.RegisterPaymentReply> registerPayment_Pre($grpc.ServiceCall call, $async.Future<$0.RegisterPaymentRequest> request) async {
    return registerPayment(call, await request);
  }

  $async.Future<$0.CheckChannelsReply> checkChannels_Pre($grpc.ServiceCall call, $async.Future<$0.CheckChannelsRequest> request) async {
  ...
  $async.Future<$0.RegisterPaymentReply> registerPayment($grpc.ServiceCall call, $0.RegisterPaymentRequest request);
  $async.Future<$0.CheckChannelsReply> checkChannels($grpc.ServiceCall call, $0.CheckChannelsRequest request);
}
@$pb.GrpcServiceName('breez.FundManager')
class FundManagerClient extends $grpc.Client {
  static final _$updateChannelPolicy = $grpc.ClientMethod<$0.UpdateChannelPolicyRequest, $0.UpdateChannelPolicyReply>(
  ...
  static final _$redeemRemovedFunds = $grpc.ClientMethod<$0.RedeemRemovedFundsRequest, $0.RedeemRemovedFundsReply>(
  ...
  static final _$registerTransactionConfirmation = $grpc.ClientMethod<$0.RegisterTransactionConfirmationRequest, $0.RegisterTransactionConfirmationResponse>(
  ...
  $grpc.ResponseFuture<$0.UpdateChannelPolicyReply> updateChannelPolicy($0.UpdateChannelPolicyRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateChannelPolicy, request, options: options);
  }

  $grpc.ResponseFuture<$0.AddFundInitReply> addFundInit($0.AddFundInitRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addFundInit, request, options: options);
  }

  $grpc.ResponseFuture<$0.AddFundStatusReply> addFundStatus($0.AddFundStatusRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addFundStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.RemoveFundReply> removeFund($0.RemoveFundRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$removeFund, request, options: options);
  }

  $grpc.ResponseFuture<$0.RedeemRemovedFundsReply> redeemRemovedFunds($0.RedeemRemovedFundsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$redeemRemovedFunds, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetSwapPaymentReply> getSwapPayment($0.GetSwapPaymentRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSwapPayment, request, options: options);
  }

  $grpc.ResponseFuture<$0.RegisterTransactionConfirmationResponse> registerTransactionConfirmation($0.RegisterTransactionConfirmationRequest request, {$grpc.CallOptions? options}) {
...
abstract class FundManagerServiceBase extends $grpc.Service {
  ...
  FundManagerServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.RegisterTransactionConfirmationRequest, $0.RegisterTransactionConfirmationResponse>(
  ...
  $async.Future<$0.UpdateChannelPolicyReply> updateChannelPolicy_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateChannelPolicyRequest> request) async {
    return updateChannelPolicy(call, await request);
  }

  $async.Future<$0.AddFundInitReply> addFundInit_Pre($grpc.ServiceCall call, $async.Future<$0.AddFundInitRequest> request) async {
    return addFundInit(call, await request);
  }

  $async.Future<$0.AddFundStatusReply> addFundStatus_Pre($grpc.ServiceCall call, $async.Future<$0.AddFundStatusRequest> request) async {
    return addFundStatus(call, await request);
  }

  $async.Future<$0.RemoveFundReply> removeFund_Pre($grpc.ServiceCall call, $async.Future<$0.RemoveFundRequest> request) async {
    return removeFund(call, await request);
  }

  $async.Future<$0.RedeemRemovedFundsReply> redeemRemovedFunds_Pre($grpc.ServiceCall call, $async.Future<$0.RedeemRemovedFundsRequest> request) async {
    return redeemRemovedFunds(call, await request);
  }

  $async.Future<$0.GetSwapPaymentReply> getSwapPayment_Pre($grpc.ServiceCall call, $async.Future<$0.GetSwapPaymentRequest> request) async {
    return getSwapPayment(call, await request);
  }

  $async.Future<$0.RegisterTransactionConfirmationResponse> registerTransactionConfirmation_Pre($grpc.ServiceCall call, $async.Future<$0.RegisterTransactionConfirmationRequest> request) async {
    return registerTransactionConfirmation(call, await request);
  }

  $async.Future<$0.UpdateChannelPolicyReply> updateChannelPolicy($grpc.ServiceCall call, $0.UpdateChannelPolicyRequest request);
  ...
  $async.Future<$0.RedeemRemovedFundsReply> redeemRemovedFunds($grpc.ServiceCall call, $0.RedeemRemovedFundsRequest request);
  $async.Future<$0.GetSwapPaymentReply> getSwapPayment($grpc.ServiceCall call, $0.GetSwapPaymentRequest request);
  $async.Future<$0.RegisterTransactionConfirmationResponse> registerTransactionConfirmation($grpc.ServiceCall call, $0.RegisterTransactionConfirmationRequest request);
}
@$pb.GrpcServiceName('breez.Swapper')
class SwapperClient extends $grpc.Client {
  ...
  static final _$getSwapPayment = $grpc.ClientMethod<$0.GetSwapPaymentRequest, $0.GetSwapPaymentReply>(
      ...
      ($0.GetSwapPaymentRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetSwapPaymentReply.fromBuffer(value));
  static final _$redeemSwapPayment = $grpc.ClientMethod<$0.RedeemSwapPaymentRequest, $0.RedeemSwapPaymentReply>(
  ...
  static final _$getReverseRoutingNode = $grpc.ClientMethod<$0.GetReverseRoutingNodeRequest, $0.GetReverseRoutingNodeReply>(
  ...
  $grpc.ResponseFuture<$0.RedeemSwapPaymentReply> redeemSwapPayment($0.RedeemSwapPaymentRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$redeemSwapPayment, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetReverseRoutingNodeReply> getReverseRoutingNode($0.GetReverseRoutingNodeRequest request, {$grpc.CallOptions? options}) {
...
abstract class SwapperServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.RedeemSwapPaymentReply> redeemSwapPayment_Pre($grpc.ServiceCall call, $async.Future<$0.RedeemSwapPaymentRequest> request) async {
    return redeemSwapPayment(call, await request);
  }

  $async.Future<$0.GetReverseRoutingNodeReply> getReverseRoutingNode_Pre($grpc.ServiceCall call, $async.Future<$0.GetReverseRoutingNodeRequest> request) async {
  ...
  $async.Future<$0.AddFundStatusReply> addFundStatus($grpc.ServiceCall call, $0.AddFundStatusRequest request);
  $async.Future<$0.GetSwapPaymentReply> getSwapPayment($grpc.ServiceCall call, $0.GetSwapPaymentRequest request);
  $async.Future<$0.RedeemSwapPaymentReply> redeemSwapPayment($grpc.ServiceCall call, $0.RedeemSwapPaymentRequest request);
  $async.Future<$0.GetReverseRoutingNodeReply> getReverseRoutingNode($grpc.ServiceCall call, $0.GetReverseRoutingNodeRequest request);
}
@$pb.GrpcServiceName('breez.CTP')
class CTPClient extends $grpc.Client {
  ...
  static final _$terminateCTPSession = $grpc.ClientMethod<$0.TerminateCTPSessionRequest, $0.TerminateCTPSessionResponse>(
  ...
  $grpc.ResponseFuture<$0.JoinCTPSessionResponse> joinCTPSession($0.JoinCTPSessionRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$joinCTPSession, request, options: options);
  }

  $grpc.ResponseFuture<$0.TerminateCTPSessionResponse> terminateCTPSession($0.TerminateCTPSessionRequest request, {$grpc.CallOptions? options}) {
...
abstract class CTPServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.JoinCTPSessionResponse> joinCTPSession_Pre($grpc.ServiceCall call, $async.Future<$0.JoinCTPSessionRequest> request) async {
    return joinCTPSession(call, await request);
  }

  $async.Future<$0.TerminateCTPSessionResponse> terminateCTPSession_Pre($grpc.ServiceCall call, $async.Future<$0.TerminateCTPSessionRequest> request) async {
    return terminateCTPSession(call, await request);
  }

  $async.Future<$0.JoinCTPSessionResponse> joinCTPSession($grpc.ServiceCall call, $0.JoinCTPSessionRequest request);
  $async.Future<$0.TerminateCTPSessionResponse> terminateCTPSession($grpc.ServiceCall call, $0.TerminateCTPSessionRequest request);
}
@$pb.GrpcServiceName('breez.NodeInfo')
class NodeInfoClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.SetNodeInfoResponse> setNodeInfo($0.SetNodeInfoRequest request, {$grpc.CallOptions? options}) {
...
abstract class NodeInfoServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.SetNodeInfoResponse> setNodeInfo_Pre($grpc.ServiceCall call, $async.Future<$0.SetNodeInfoRequest> request) async {
...
@$pb.GrpcServiceName('breez.SyncNotifier')
class SyncNotifierClient extends $grpc.Client {
  static final _$registerPeriodicSync = $grpc.ClientMethod<$0.RegisterPeriodicSyncRequest, $0.RegisterPeriodicSyncResponse>(
  ...
  $grpc.ResponseFuture<$0.RegisterPeriodicSyncResponse> registerPeriodicSync($0.RegisterPeriodicSyncRequest request, {$grpc.CallOptions? options}) {
...
abstract class SyncNotifierServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.RegisterPeriodicSyncResponse> registerPeriodicSync_Pre($grpc.ServiceCall call, $async.Future<$0.RegisterPeriodicSyncRequest> request) async {
    return registerPeriodicSync(call, await request);
  }

  $async.Future<$0.RegisterPeriodicSyncResponse> registerPeriodicSync($grpc.ServiceCall call, $0.RegisterPeriodicSyncRequest request);
}
@$pb.GrpcServiceName('breez.PushTxNotifier')
class PushTxNotifierClient extends $grpc.Client {
  static final _$registerTxNotification = $grpc.ClientMethod<$0.PushTxNotificationRequest, $0.PushTxNotificationResponse>(
  ...
  $grpc.ResponseFuture<$0.PushTxNotificationResponse> registerTxNotification($0.PushTxNotificationRequest request, {$grpc.CallOptions? options}) {
...
abstract class PushTxNotifierServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.PushTxNotificationResponse> registerTxNotification_Pre($grpc.ServiceCall call, $async.Future<$0.PushTxNotificationRequest> request) async {
    return registerTxNotification(call, await request);
  }

  $async.Future<$0.PushTxNotificationResponse> registerTxNotification($grpc.ServiceCall call, $0.PushTxNotificationRequest request);
}
@$pb.GrpcServiceName('breez.InactiveNotifier')
class InactiveNotifierClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.InactiveNotifyResponse> inactiveNotify($0.InactiveNotifyRequest request, {$grpc.CallOptions? options}) {
...
abstract class InactiveNotifierServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.InactiveNotifyResponse> inactiveNotify_Pre($grpc.ServiceCall call, $async.Future<$0.InactiveNotifyRequest> request) async {
    return inactiveNotify(call, await request);
  }

  $async.Future<$0.InactiveNotifyResponse> inactiveNotify($grpc.ServiceCall call, $0.InactiveNotifyRequest request);
}
@$pb.GrpcServiceName('breez.PaymentNotifier')
class PaymentNotifierClient extends $grpc.Client {
  static final _$registerPaymentNotification = $grpc.ClientMethod<$0.RegisterPaymentNotificationRequest, $0.RegisterPaymentNotificationResponse>(
  ...
  $grpc.ResponseFuture<$0.RegisterPaymentNotificationResponse> registerPaymentNotification($0.RegisterPaymentNotificationRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerPaymentNotification, request, options: options);
  }
}

@$pb.GrpcServiceName('breez.PaymentNotifier')
abstract class PaymentNotifierServiceBase extends $grpc.Service {
  $core.String get $name => 'breez.PaymentNotifier';

  PaymentNotifierServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.RegisterPaymentNotificationRequest, $0.RegisterPaymentNotificationResponse>(
  ...
  $async.Future<$0.RegisterPaymentNotificationResponse> registerPaymentNotification_Pre($grpc.ServiceCall call, $async.Future<$0.RegisterPaymentNotificationRequest> request) async {
    return registerPaymentNotification(call, await request);
  }

  $async.Future<$0.RegisterPaymentNotificationResponse> registerPaymentNotification($grpc.ServiceCall call, $0.RegisterPaymentNotificationRequest request);
}
@$pb.GrpcServiceName('breez.Signer')
...
abstract class SignerServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.SignUrlResponse> signUrl_Pre($grpc.ServiceCall call, $async.Future<$0.SignUrlRequest> request) async {
    return signUrl(call, await request);
  }

  $async.Future<$0.SignUrlResponse> signUrl($grpc.ServiceCall call, $0.SignUrlRequest request);
}
@$pb.GrpcServiceName('breez.Support')
class SupportClient extends $grpc.Client {
  static final _$reportPaymentFailure = $grpc.ClientMethod<$0.ReportPaymentFailureRequest, $0.ReportPaymentFailureReply>(
  ...
  $grpc.ResponseFuture<$0.ReportPaymentFailureReply> reportPaymentFailure($0.ReportPaymentFailureRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$reportPaymentFailure, request, options: options);
  }

  $grpc.ResponseFuture<$0.BreezStatusReply> breezStatus($0.BreezStatusRequest request, {$grpc.CallOptions? options}) {
...
abstract class SupportServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ReportPaymentFailureReply> reportPaymentFailure_Pre($grpc.ServiceCall call, $async.Future<$0.ReportPaymentFailureRequest> request) async {
    return reportPaymentFailure(call, await request);
  }

  $async.Future<$0.BreezStatusReply> breezStatus_Pre($grpc.ServiceCall call, $async.Future<$0.BreezStatusRequest> request) async {
    return breezStatus(call, await request);
  }

  $async.Future<$0.ReportPaymentFailureReply> reportPaymentFailure($grpc.ServiceCall call, $0.ReportPaymentFailureRequest request);
