...
class _PosPaymentDialogState extends State<PosPaymentDialog> {
  ...
  void initState() {
    ...
    _timerSubscription = _paymentTimer.stream.listen((d) {
      setState(() {
        _countdownString = context.l10n.pos_dialog_clock(
        ...
        Row(
          children: <Widget>[
            ...
            IconButton(
              ...
              color: buttonColor,
              tooltip: l10n.pos_dialog_invoice_copy,
              onPressed: () {
                ServiceInjector()
                    .device
                ...
                showFlushbar(
                  context,
                  message: l10n.pos_dialog_invoice_copied,
