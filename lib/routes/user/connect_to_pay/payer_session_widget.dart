  ...
  Widget build(BuildContext context) {
    ...
    if (sessionState.paymentFulfilled) {
      ...
      if (sessionState.payeeData.status.online) {
        ...
        message = "Tap the Share button to share a link with a person that you want to pay. Then, please wait while this person clicks the link and joins the session.";
      } else {
