  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: new AlertDialog(
        title: Text(getTitleText(), style: Theme.of(context).dialogTheme.titleTextStyle, textAlign: TextAlign.center),
        content: getContent(),
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: <Widget>[
      ...
      Row(
        ...
        children: <Widget>[
          Expanded(
            flex: 1,
            child: Text("Transaction ID:", style: Theme.of(context).primaryTextTheme.display1),
          ),
          Expanded(
              child: Container(
            height: 36.0,
