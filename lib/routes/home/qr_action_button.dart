        ...
        child: FloatingActionButton(
          onPressed: () async {
            ...
            if (scannedString != null) {
              ...
              // lnurl string
              if (isLNURL(lower)) {
                _log.v("Scanned string is a lnurl");
              ...
              if (v != null) {
                _log.v("Scanned string is a lightning address");
              ...
              if (lnInvoice != null) {
                _log.v("Scanned string is a bolt11 extract from bip 21");
                lower = lnInvoice;
              }

              // regular lightning invoice.
              if (lower.startsWith("lightning:") || lower.startsWith("ln")) {
                _log.v("Scanned string is a regular lightning invoice");
              ...
              if (await _isBTCAddress(btcInvoice.address)) {
                _log.v("Scanned string is a bitcoin address");
              ...
              if (nodeID != null) {
                _log.v("Scanned string is a node id");
                Navigator.of(context).push(FadeInRoute(
              ...
              if (await canLaunchUrlString(scannedString)) {
                _log.v("Scanned string is a launchable url");
              ...
              if (validUrl) {
                _log.v("Scanned string is a valid url");
                _handleWebAddress(context, scannedString);
                return;
              }

              _log.v("Scanned string is unrecognized");
              showFlushbar(
                context,
