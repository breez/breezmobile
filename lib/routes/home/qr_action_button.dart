      ...
      child: SizedBox(
        ...
        child: FloatingActionButton(
          onPressed: () async {
            ...
            await Navigator.pushNamed<String>(
              context,
              "/qr_scan",
            ).then(
              (scannedString) async {
                if (scannedString != null) {
                  ...
                  await _isBTCAddress(btcInvoice.address).then(
                    (isBTCAddress) {
                      if (isBTCAddress) {
                    ...
                    (_) async {
                      ...
                      await canLaunchUrlString(scannedString).then(
                        (canLaunchUrlString) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () async {
                await launchLinkOnExternalBrowser(url).then(
