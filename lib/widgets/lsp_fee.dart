...
String _formatFeeMessage(AccountModel acc, LSPInfo lsp) {
  if (acc.connected) {
    ...
    return "A setup fee of ${lsp.channelFeePermyriad / 100}% with a minimum of ${lsp.channelMinimumFeeMsat / 1000} sats will be applied for buying more than $liquidity.";
  }
